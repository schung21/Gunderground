...
public class VendingMachine : MonoBehaviour
{
    ...
    private void Start()
    {
        if (CharTracker.instance.vendingTime1 != "" || CharTracker.instance.vendingTime1 != null)
        {
            lastVendTime = CharTracker.instance.vendingTime1;
        }
    ...
    public void Update()
    {
        ...
        if (span.TotalMinutes >= 0.17 || currentTime.Date > lastTimeClicked.Date || lastVendTime == "")
        {
            ...
            if (CharTracker.instance.vendingTime1 != "")
            {
                CharTracker.instance.vendingTime1 = "";
